# Rakuten E-commerce Multimodal Classification

**Difficulty:** 10/10 &middot; **Task type:** Multimodal CV+NLP
...
```bash
git clone https://github.com/Sandyyy123/liora-06-rakuten-multimodal.git
cd liora-06-rakuten-multimodal
